...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <a class="btn btn-primary btn-sm mb-0 bg-gradient-danger " style="margin-left:20px; margin-top:20px;" href="https://www.creative-tim.com/product/argon-dashboard-pro?ref=sidebarfree" type="button">Kembali</a>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Picture</th>
                    ...
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Amount/g</th>
